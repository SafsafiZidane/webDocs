  ...
  return (
    <>
      ...
      before:absolute"> {[...Array(2)].map((arr)=>(
        ...
        className="flex
        flex-nowrap
        animate-slide" > {CLIENTS.map((client)=>(
          <div key={client.alt} className="relative
          w-[150px]
          m-20
          shrink-0
          flex
      ...
      relative">
        ...
        top-22"/>
          ...
          subheading="capture your ideas,thoughts,and meeting notes in a String"
          pill="Features"
          />
      ...
      <div className="w-full
        ...
        top-56"/>
          ...
          subheading="join thousands of satisfied use personal and professional productivity needs"
          pill="Testimonials" />
        ...
        <TitleSection title="The perfect plan for you"
          ...
          mt-10">
            {PRICING_CARDS.map((card)=>(
              ...
              <p className="dark:textwashed-purple-800 ml-1">{card.description}</p>
