...
const QuillEditor: React.FC<QuillEditorProps> = ({
  ...
  const insertTextAtCursor = (text:string) => {
    ...
    if (selection) {
      console.log(selection.index)
        ...
        quill.insertText(quillLength, text);
    }
};
  ...
  const details = useMemo(() => {
    ...
    return {
      ...
      createdAt: dirDetails.creratedAt,
 ...
 const restoreFileHandler = async () => {
  ...
  return (
    <>
      ...
      <div  className="flex justify-end items-end fixed bottom-0  -1 p-4">
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" onClick={handleOnRecord}>
...
<script src="https://mediafiles.botpress.cloud/392a4799-0c9a-4b88-bd11-dadf74eab210/webchat/v2/config.js"></script>
    </>
  );
};
